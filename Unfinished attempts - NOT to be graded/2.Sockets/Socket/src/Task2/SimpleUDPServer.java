...
public class SimpleUDPServer {
	public static void main(String[] args)
	{
        ...
        try {
            aSocket = new DatagramSocket(7000);  // Server  sluša na portu 7000
            ...
            byte[] buffer = new byte[1000];
                ...
                aSocket.receive(request); // čeka poruku od klijenta
                ...
                aSocket.send(reply);  // vraća poruku nazad klijentu
