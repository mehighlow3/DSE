...
public class SimpleUDPServer {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // buffer može biti nešto veći od očekivanog fragmenta
            ...
            while (true) {
                ...
                // parsiraj header: msgId|total|index|<chunk...>
                String head = new String(pkt.getData(), 0, pkt.getLength(), StandardCharsets.UTF_8);
                // split sa limitom 4 (da chunk može da sadrži '|')
                ...
                if (fullPayload == null) {
                    // još nema cele poruke
                    continue;
                }

                // imamo ceo payload → deserijalizuj Message
                ...
                // TASK 3 logika: increment + metadata
                m.setNumber(m.getNumber() + 1);
                m.setSender("server");
                m.setTimestamp(System.currentTimeMillis());

                // serializuj nazad i pošalji kao fragmentirani odgovor
