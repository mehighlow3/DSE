...
public class UDPFragmenter {
    ...
    // "Siguran" payload po paketu, ostavlja mesta za header
    private static final int MAX_CHUNK_BYTES = 1200;

    /**
     * Fragmentuje arbitrarni string payload u više UDP paketa sa headerom:
    ...
    public static List<DatagramPacket> fragment(
        ...
        for (int i = 0; i < totalChunks; i++) {
            ...
            // header kao ASCII: "msgId|total|index|"
