...
public class UDPFragmenter {
    ...
    private static final int MAX_CHUNK_BYTES = 1200; // ili 1400 ako želiš manje fragmenata

    public static List<DatagramPacket> fragment(String payload, InetAddress address, int port, int msgId) {
