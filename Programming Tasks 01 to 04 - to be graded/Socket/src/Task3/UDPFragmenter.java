...
public class UDPFragmenter {
    ...
    // "Safe" payload size per packet; leaves enough room for headers
    private static final int MAX_CHUNK_BYTES = 1200;

    /**
     * Fragments an arbitrary string payload into multiple UDP packets with a header:
     * msgId|total|index| + raw chunk bytes (UTF-8)
     */
    public static List<DatagramPacket> fragment(
        ...
        for (int i = 0; i < totalChunks; i++) {
            ...
            // header as ASCII: "msgId|total|index|"
